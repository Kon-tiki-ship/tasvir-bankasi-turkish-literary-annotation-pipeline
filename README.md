...
[![GitHub release](https://img.shields.io/badge/release-v0.1.0--public--preview-blue)](https://github.com/Kon-tiki-ship/tasvir-bankasi-turkish-literary-annotation-pipeline/releases/tag/v0.1.0-public-preview)
...
| Download the public-preview pipeline release | [GitHub release v0.1.0-public-preview](https://github.com/Kon-tiki-ship/tasvir-bankasi-turkish-literary-annotation-pipeline/releases/tag/v0.1.0-public-preview) |
...
| --------------------------------------- | ------------------------: | --------------------------------------------------------------- |
| GitHub public-safe pipeline package     |   `v0.1.0-public-preview` | Pipeline, schema, validator, documentation, smoke/probe samples |
...
GitHub public-preview release:

```text
https://github.com/Kon-tiki-ship/tasvir-bankasi-turkish-literary-annotation-pipeline/releases/tag/v0.1.0-public-preview
```
...
[1]: https://github.com/Kon-tiki-ship/tasvir-bankasi-turkish-literary-annotation-pipeline/releases "Releases · Kon-tiki-ship/tasvir-bankasi-turkish-literary-annotation-pipeline · GitHub"
