...
![GitHub release](https://img.shields.io/badge/release-v0.1.1--public--preview-blue)
![Dataset](https://img.shields.io/badge/Hugging%20Face-gated%20dataset-yellow)
![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.20579958-blue)
![Data license](https://img.shields.io/badge/data-CC%20BY--NC%204.0-lightgrey)
![Code license](https://img.shields.io/badge/code-PolyForm%20Noncommercial%201.0.0-lightgrey)
...
Download the public-preview pipeline release	GitHub releases
Access the full gated dataset	Hugging Face dataset
Cite the publication dataset	Zenodo DOI
